const PageState = (function () {
  ...
  const offerGroup = {
    of1: {
      name: "B&B World",
      srcPhoto: "assets/imgs/b&b-world.jpg",
      id: 0,
      description:
    ...
    of2: {
      name: "Women's World",
      srcPhoto: "assets/imgs/women's-world.jpg",
      id: 1,
      description:
    ...
    of3: {
      name: "Man's World",
      srcPhoto: "assets/imgs/man's-world.jpg",
      id: 2,
      description:
    ...
    of4: {
      name: "World Pump",
      srcPhoto: "assets/imgs/pump-world.jpg",
      id: 3,
      description:
    ...
    of5: {
      name: "Booty World",
      srcPhoto: "assets/imgs/booty-world.jpg",
      id: 4,
      description:
    ...
    of6: {
      name: "Body Sculpt",
      srcPhoto: "assets/imgs/body-sculpt.jpg",
      id: 5,
      description:
    ...
    of7: {
      name: "Cellu Stop",
      srcPhoto: "assets/imgs/cellu-stop.jpg",
      id: 6,
      description:
    ...
    of8: {
      name: "Fat Burn",
      srcPhoto: "assets/imgs/fat-burn.jpg",
      id: 7,
      description:
  ...
  <video src="assets/imgs/bg.mp4" autoplay muted loop type="mp4"></video>`;
  };
  // About Us State
  const aboutUsState = function () {
    ...
    <div class="image"><img src="assets/imgs/about-me.png"></img></div>
    </div>
